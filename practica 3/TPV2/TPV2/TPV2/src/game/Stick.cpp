...
void Stick::addPlayer(std::uint8_t id) {
	initPlayer(id);
	player_id_ = id;
	send_my_info();
}

void Stick::initPlayer(std::uint8_t id) {
...
void Stick::removePlayer(std::uint8_t id) {
	players_[id].state = Stick::NOT_USED;
}

void Stick::update_player_state(Uint8 id, float x, float y, float w, float h,
	float rot) {
...
void Stick::killPlayer(std::uint8_t id) {
	players_[id].state = Stick::DEAD;
}

void Stick::update_player_info(Uint8 id, float x, float y, float w, float h,
